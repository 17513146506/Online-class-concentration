...
class CamConfig:
    def __init__(self):
        ...
        Ui_MainWindow.printf(window,"开始执行网课专注度检测...")
        # 初始化
        pt = pyttsx3.init()
        # 说什么
        pt.say("开始执行网课专注度检测")
        ...
        if success:
            ...
            for i in lab:
                if(i == "phone"):
                    ...
                    window.label_9.setText("<font color=red>请专注上课</font>")
                    # 初始化
                    pt = pyttsx3.init()
                    # 说什么
                    pt.say("请专注上课")
                    ...
                    window.label_7.setText("<font color=red>正在玩笔</font>")
                    winsound.Beep(600, 1000)
                    window.label_9.setText("<font color=red>请专注上课</font>")
                    # 初始化
                    pt = pyttsx3.init()
            ...
            if Roll == 100:
                ...
                if perclos > 0.02:
                    Ui_MainWindow.printf(window,"当前上课状态不佳状态")
                    window.label_10.setText("<font color=red>瞌睡！！！</font>")
                    winsound.Beep(600, 1000)
                    # playsound('pilao.mp3')
                    # 初始化
                    pt = pyttsx3.init()
                    # 说什么
                    pt.say("当前上课状态不佳，出现瞌睡")
                    # 开始说吧
                    pt.runAndWait()
                    Ui_MainWindow.printf(window,"")
                else:
                ...
                Rolleye = 0
                Rollmouth = 0
                Ui_MainWindow.printf(window,"....重新开始执行不专注度检测....")
def CamConfig_init():
